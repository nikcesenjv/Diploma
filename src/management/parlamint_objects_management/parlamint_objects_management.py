...
"""def parse_parlamint_attendees(property_element: dict[str, str | list], attendees: list[ParlamintAttendee],
    ...
    # attendee_names = " ".join(get_grouped_capitals(attendee_names))
    attendee_names = get_grouped_capitals(" ".join(paragraphs))
    ...
    for attendee_name in attendee_names:
        ...
        parlamint_document_attendees.append(ParlamintAttendee(attendee_name, attendee_type))
