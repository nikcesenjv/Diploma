...
from src.objects.general_objects import InnerFolder

def find_by_inner_folder(inner_folders: list[InnerFolder], params: dict) -> list[InnerFolder]:
...
def find_by_num(inner_folders: list[InnerFolder], num: str) -> list[InnerFolder]:
    return [inner_folder for inner_folder in inner_folders if inner_folder.num == num]

def find_by_spec_num(inner_folders: list[InnerFolder], num: str) -> list[InnerFolder]:
    return [inner_folder for inner_folder in inner_folders if num in inner_folder.num]

def find_by_meeting(inner_folders: list[InnerFolder], meeting: str) -> list[InnerFolder]:
